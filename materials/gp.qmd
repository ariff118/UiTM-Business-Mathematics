...
### **Submission**\
The assignment must be submitted into Google Drive folder assigned by your instructors **before end of Week 11 (refer task for exact date)**. Failing to comply with the deadline given will result in deduction of marks.\
...
In your own terms, elucidate the concept of annuity and succinctly delineate its distinctions from compound interest. If deemed necessary, furnish an illustrative example to substantiate your discourse.\

:::

::: {.callout-note}
## **Case Study 1:** Annuities and Compound Interest Integration\

[**Scenario:**]{style="color:blue;"}
Alex is planning for retirement and is considering two annuity options: Annuity A, which pays RM1,500 every quarter, and Annuity B, which pays RM6,000 annually. Both annuities offer a fixed interest rate of 4% per annum, compounded quarterly. Alex intends to invest in one of these annuities for a period of 10 years.

:::

[**Question:**]{style="color:green;"}\
1. Calculate the future value of both Annuity A and Annuity B after 10 years.\
2. Analyze and explain the impact of the payment frequency on the future value of the annuities, considering the quarterly compounding of interest.\
3. If Alex decides to extend the investment period to 15 years, recalculate the future value for both annuities and discuss how the extended time horizon affects the overall returns.\

::: {.callout-note}
## Case Study 2: Hire-Purchase Agreement and Annuities\

[**Scenario:**]{style="color:blue;"}
Emily is interested in purchasing a newly launched Proton S70 model, which costs RM73,800. She plans to finance the car through a hire-purchase agreement with a minimum down payment of 10% of the car price. The remaining amount will be financed through monthly payments over a 9-year period at an annual interest rate of 3.5% compounded monthly.\

:::

[**Question:**]{style="color:green;"}\
1. Calculate the minimum down payment that Emily needs to make for the Proton S70.\
2. Determine the monthly payment Emily must make over the 9-year period to complete the hire-purchase agreement.\
3. Analyze and discuss the implications of the interest rate on the total amount paid by Emily over the financing period.\

[**DUE DATE: 31.12.2023**]{style="color:red;"}
:::